...
module.exports = {
   ...
   * @param {Object} options The options as defined in the [DSE
   * Driver]{@link http://docs.datastax.com/en/drivers/nodejs-dse/1.0/ExecutionProfile.html}.
   * @example
   ...
   */
  createExecutionProfile: function (name, options) {

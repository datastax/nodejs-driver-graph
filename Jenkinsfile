...
def initializeEnvironment() {
  ...
  sh label: 'Download DataStax Enterprise', script: '''#!/bin/bash -lex
...
def describeScheduledTestingStage() {
  script {
    ...
    currentBuild.description = "${type} scheduled build and testing of all supported DataStax Enterprise against multiple Node.js runtimes"
  }
}
...
pipeline {
  ...
  parameters {
    ...
    choice(
      ...
      choices: ['dse-5.1', // Legacy DataStax Enterprise
                'dse-6.0', // Previous DataStax Enterprise
                'dse-6.7', // Current DataStax Enterprise
                'dse-6.8', // Development DataStax Enterprise
                'ALL'],
      description: '''DataStax Enterprise server version to use for adhoc <b>BUILD-AND-EXECUTE-TESTS</b> <strong>ONLY!</strong>
                      <table style="width:100%">
                        <col width="15%">
                        <col width="85%">
                        <tr>
      ...
      matrix {
        ...
        excludes {
          ...
          exclude {
            ...
            axis {
              name 'CASSANDRA_VERSION'
              values 'dse-5.1', 'dse-6.0', 'dse-6.7'
            }
          }
          exclude {
            axis {

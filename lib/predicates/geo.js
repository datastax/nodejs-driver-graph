...
var geometry = require('dse-driver').geometry;
var P = glv.process.P;

var degreesToRadians = Math.PI / 180;
var earthMeanRadiusKm = 6371.0087714;
var degreesToKm = degreesToRadians * earthMeanRadiusKm;
var kmToDegrees = 1 / degreesToKm;
var kmToMiles = 0.621371192;
var milesToKm = 1 / kmToMiles;
...
function inside(centerOrShape, radius, unit) {
  ...
  if (centerOrShape instanceof geometry.Point) {
    validateUnit(unit);
    return new GeoP(operator, new Distance(centerOrShape, toDegrees(radius, unit)));
  }
  ...
  return new GeoP(operator, centerOrShape);
}
